...
const navItems = [
  { name: "Pool Designs", href: "/" },
  { name: "Custom Features", href: "/" },
  { name: "About", href: "/" },
  { name: "Pool Gallery", href: "/" },
  { name: "Contact", href: "/" },
];
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start space-y-8 lg:space-y-0">
            ...
            <div className="lg:ml-12">
              <ul className="space-y-2 text-sm">
                <li><Link to="/" className="text-text-strong hover:text-accent-primary transition-colors">POOL DESIGNS</Link></li>
                <li><Link to="/" className="text-text-strong hover:text-accent-primary transition-colors">CUSTOM FEATURES</Link></li>
                <li><Link to="/" className="text-text-strong hover:text-accent-primary transition-colors">ABOUT</Link></li>
                <li><Link to="/" className="text-text-strong hover:text-accent-primary transition-colors">POOL GALLERY</Link></li>
                <li><Link to="/" className="text-text-strong hover:text-accent-primary transition-colors">CONTACT</Link></li>
                <li><Link to="/" className="text-text-strong hover:text-accent-primary transition-colors">BLOG</Link></li>
              </ul>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-border">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-4">
                {/* Instagram */}
                <Link to="/" aria-label="Instagram" className="text-text-strong hover:text-accent-primary transition-colors">
                  <Instagram size={18} />
                </Link>
                {/* Facebook */}
                <Link to="/" aria-label="Facebook" className="text-text-strong hover:text-accent-primary transition-colors">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </Link>
                {/* LinkedIn */}
                <Link to="/" aria-label="LinkedIn" className="text-text-strong hover:text-accent-primary transition-colors">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                {/* TikTok */}
                <Link to="/" aria-label="TikTok" className="text-text-strong hover:text-accent-primary transition-colors">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                {/* YouTube */}
                <Link to="/" aria-label="YouTube" className="text-text-strong hover:text-accent-primary transition-colors">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
